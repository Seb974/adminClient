...
const Group = ({ match, history }) => {
    ...
    const [group, setGroup] = useState({ label: "", hasAdminAccess: false, hasShopAccess: true, hasStoreAccess: false, subjectToTaxes: true, dayInterval: 0, onlinePayment: true, hourLimit: new Date(today.getFullYear(), today.getMonth(), today.getDate(), 23, 59, 0), soldOutNotification: false, paymentParcel: false});
            ...
            GroupActions.find(id)
                .then( response => {
                    const newGroup = {
                        ...
                        paymentParcel: isDefined(response.paymentParcel) ? response.paymentParcel : group.paymentParcel
                    };
                    setGroup(newGroup);
                })
                                ...
                                <>
                                    ...
                                    <CRow className="mb-5 ml-1">
                                        ...
                                        <CCol xs="12" sm="12" md="6" className="d-flex align-items-center">
                                            <CFormGroup row className="mb-0 mt-4 d-flex align-items-center">
                                                <CCol xs="3" sm="2" md="3">
                                                    <CSwitch name="paymentParcel" color="dark" shape="pill" variant="opposite" checked={ group.paymentParcel } onChange={ handleCheckBoxes }/>
                                                </CCol>
                                                <CCol tag="label" xs="9" sm="10" md="9" className="col-form-label">
                                                    Paiement du colisage
                                                </CCol>
                                            </CFormGroup>
                                        </CCol>
                                        <CCol xs="12" sm="12" md="6" className="d-flex align-items-center">
