...
const ProductPage = ({ match, history }) => {
    ...
    const now = new Date();
    const today = getDateFrom(now, 0, 4, 0, 0);
    ...
    const defaultComponent = { product : null, variation: null, size: null, count: 0, quantity: ""};
